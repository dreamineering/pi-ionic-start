...
module.exports = angular.module('drmg.services.google', [])
...
.factory('googleLoginApi',
  function($q, $rootScope, googleAuthApi, googleApi) {
    ...
    var loadedPromise = loadedDefer.promise;
...
.factory('googleCalendarApi',
  function($timeout, $q, $rootScope, googleApi, googleAuthApi) {
    var calendarCache = [];
    var loadedCalendar = $q.defer();
    var loadedPromise = loadedCalendar.promise;
    ...
    var getCalendars = function() {
      ...
      googleAuthApi.authorize().then(function() {
    ...
    var createCalendar = function(id) {
      console.log('create calender for id', id);
